...
export interface IKMS {
    ...
    packv2(publicKeyJWK: IJWK, senderVerificationMethodId: string, receiptKeys: {
        publicKeyJWK: IJWK;
        verificationMethodId: string;
    }[], message: IDIDCommMessage, packing: DIDCommMessagePacking): Promise<IPackedDIDCommMessage>;
