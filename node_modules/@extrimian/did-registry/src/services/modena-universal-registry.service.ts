...
export type ModenaUniversalUpdateRequest = UpdateDIDRequest & { didMethod?: string };
...
export class ModenaUniversalRegistry extends ModenaRegistryBase<ModenaUniversalPublishRequest> {
    ...
    async updateDID(params: ModenaUniversalUpdateRequest) {
        ...
        const options = {
            ...
            body: JSON.stringify({
                modenaRequest: JSON.stringify(request),
